...
router.get('/set', (req,res) => {
    ...
    const pixels = req.app.locals.pixelChanges;
    const size = req.app.locals.size;
    ...
    pixels.setPixel(coord_x,coord_y,color);
...
router.get('/picture', async (req,res) => {
    ...
    const saver = req.app.locals.pixelSaver;

    const buffer = await saver.getPicture();
    res.writeHead(200, {
...
router.get('/changes', (req,res) => {
    ...
    const resp = pixels.getChanges(index);
